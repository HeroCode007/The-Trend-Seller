...
export const casualWatches = [
  ...
  {
    id: 68,
    slug: 'tomi-dual-dial-minimalist-gold-navy',
    name: 'TOMI Dual-Dial Minimalist Gold & Navy',
    productCode: 'TTS-CW-068',
    price: 3450,
    compareAtPrice: 4800,
    image: '/images/tomi-dual-dial-packshot.jpg',
    images: [
      '/images/tomi-dual-dial-packshot.jpg',
      '/images/tomi-dual-dial-hero-close.jpg',
      '/images/tomi-dual-dial-wrist.jpg',
      '/images/tomi-dual-dial-macro.jpg',
      '/images/tomi-dual-dial-angle.jpg',
      '/images/tomi-dual-dial-box.jpg',
      '/images/tomi-dual-dial-raw.jpg',
      '/images/tomi-dual-dial-studio-collage.jpg'
    ],
    description: 'A masterclass in contemporary horological minimalism. The TOMI Dual-Dial timepiece pairs an ultra-slim 18k yellow gold-plated round case with a captivating midnight navy dial featuring an eccentric sub-dial complication. Designed for the modern gentleman, its dual-ring architecture pairs slender gold hands with clean precision index markers, creating a balanced aesthetic that transitions effortlessly from boardroom elegance to weekend style. Secured with a supple stitched black leather strap and packaged in the official TOMI presentation box.',
    features: [
      '18k yellow gold-plated polished slim round case',
      'Deep midnight navy dial with eccentric sub-dial complication',
      'Dual-dial architecture with minimalist gold hands & precision markers',
      'Ultra-supple stitched black genuine leather strap',
      'Polished gold pin-buckle closure with engraved detailing',
      'Includes official branded TOMI luxury gift presentation box',
      'Scratch-resistant hardened mineral crystal glass',
      'High-precision Japanese quartz movement with daily water resistance'
    ],
    category: 'casual-watches',
    inStock: true,
  }
