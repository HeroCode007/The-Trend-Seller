...
export const premiumWatches = [
  ...
  {
    id: 5,
    slug: 'hublot-classic-fusion-premium',  // ← FIXED: Added "-premium" to differentiate
...
export const casualWatches = [
  ...
  {
    id: 15,
    slug: 'hublot-big-bang-unico',  // ← FIXED: Slug matches name
    ...
    features: ['Titanium case', 'Sapphire crystal', 'Bold design', 'Fusion philosophy'],
    category: 'casual-watches',
    inStock: true,
  }
];
...
export const stylishWatches = [
  {
    id: 16,
    slug: 'patek-philippe-nautilus-white',  // ← FIXED: Descriptive unique slug
    name: 'Patek Philippe Nautilus White',  // ← FIXED: Unique name
  ...
  {
    id: 17,
    slug: 'sveston-royal',  // ← FIXED: Slug matches name
    name: 'Sveston Royal',
