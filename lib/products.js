...
export const premiumWatches = [
  ...
  },
  {
    ...
    description: 'A horological masterpiece for the discerning collector. This ultra-luxury timepiece features a perpetual calendar that tracks dates, months, and leap years without adjustment, paired with a romantic moon phase complication. Housed in a platinum case and powered by Swiss precision movement',
  ...
  },
  {
    ...
    description: 'The Hublot Classic Fusion seamlessly bridges tradition and innovation. Its minimalist dial philosophy lets the polished titanium case take center stage, while the innovative rubber-leather fusion strap offers unprecedented comfort. The transparent case back showcases the automatic movements hypnotic dance, making every glance a reminder of mechanical excellence.',
    features: [
...
export const casualWatches = [
  ...
  },
  {
    ...
    productCode: 'TTS-CW-014',
    price: 4299,
    image: '/images/C5.jpg',
    description: 'Bold, dynamic, and unapologetically modern. The Big Bang Unico features Hublot\'s signature fusion design philosophy with a commanding presence on the wrist. Premium titanium construction paired with sapphire crystal creates a timepiece that\'s both lightweight and virtually indestructible—ready for whatever your day throws at it.',
    features: ['Titanium case', 'Sapphire crystal glass', 'Titanium bracelet', 'Titanium crown'],
    category: 'casual-watches'
  }
];
...
export const stylishWatches = [
  ...
  },
  {
    ...
    price: 4899,
    image: '/images/S3.jpg',
    description: 'Regal sophistication for the modern era. The Sveston Royal commands attention with its refined proportions and meticulous finishing. Premium titanium is crafted to mirror perfection, while the white dial provides exceptional legibility. The chocolate brown leather strap adds warmth and classic appeal, making this watch equally at home at weddings or wine tastings.',
    features: [
      'Stainless steel case',
      'White dial with luminescent markers',
      'Brown leather strap with folding clasp',
